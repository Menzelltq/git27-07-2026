...
const studentInfo = {
    participant: (studentID: string, name: string, age: number, hasPaid: boolean) => ({
        studentID, name, age, hasPaid
    })
};

const studentData = [
    studentInfo.participant("ST001", "Ahmad Fauzi", 16, true),
    studentInfo.participant("ST002", "Siti Nurhaliza", 17, false),
    studentInfo.participant("ST003", "Budi Santoso", 16, true)
];
