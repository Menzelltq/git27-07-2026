...
const currentStock: number=18;

console.log("=== Product Data ===");
console.log({ productName, productCode, originalPrice, discountPercentage, quantity, discountedPrice, totalPrice, isPremiumMember, currentStock });
