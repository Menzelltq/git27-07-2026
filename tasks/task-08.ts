...
const temperatureData = [
    temperatureInfo.temperature("08:00", 24.5),
    temperatureInfo.temperature("09:00", 25.1),
    temperatureInfo.temperature("10:00", 26.8),
    temperatureInfo.temperature("11:00", 28.4),
    temperatureInfo.temperature("12:00", 30.2),
    temperatureInfo.temperature("13:00", 31.1),
    temperatureInfo.temperature("14:00", 30.7),
    temperatureInfo.temperature("15:00", 29.3)
];
